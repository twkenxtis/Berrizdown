...
def main(version: bool, debug: bool) -> None:
    """pywidevinex—Python Widevine CDM implementation."""
    ...
    log.info("pywidevinex version %s Copyright (c) %s rlaphoenix, DevLARLEY", __version__, copyright_years)
    log.info("https://git.gay/ready-dl/pywidevine")
    if version:
        return
...
def license_(device_path: Path, pssh: PSSH, server: str, license_type: str, privacy: bool) -> None:
    ...
    new script that imports and uses the pywidevinex module instead. This generic function
    is only useful as a quick generic license call.

    This is also a great way of showing you how to use pywidevinex in your own projects.
    """
