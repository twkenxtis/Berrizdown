...
from pyplayready.misc.exceptions import InvalidChecksum, InvalidWrmHeader
...
class WRMHeader:
    ...
    class SignedKeyID:
        ...
        def __init__(self, value: UUID, alg_id, checksum: bytes | None):
            self.value = value
            self.alg_id = alg_id
            self.checksum = checksum

        @classmethod
        def load(cls, value: str, alg_id: str, checksum: str | None):
            return cls(
    ...
    def __init__(self, data: str | bytes):
        ...
        self.la_url: str | None = None
        self.lui_url: str | None = None
        self.ds_id: str | None = None
        self.custom_attributes: ET.Element | None = None
        self.decryptor_setup: str | None = None
