...
from pyplayready import Crypto, ECCKey
...
class XmlBuilder:
    ...
    def _LicenseAcquisition(
        ...
        revocation_lists: list[UUID] | None = None,
    ) -> ET.Element:
        LA = ET.SubElement(
            parent,
            "LA",
        ...
        KeyInfo = ET.SubElement(EncryptedData, "KeyInfo", {"xmlns": "http://www.w3.org/2000/09/xmldsig#"})

        EncryptedKey = ET.SubElement(KeyInfo, "EncryptedKey", {"xmlns": "http://www.w3.org/2001/04/xmlenc#"})
        ET.SubElement(
            EncryptedKey,
            "EncryptionMethod",
        ...
        KeyInfoInner = ET.SubElement(EncryptedKey, "KeyInfo", {"xmlns": "http://www.w3.org/2000/09/xmldsig#"})
    ...
    def _SignedInfo(parent: ET.Element, digest_value: bytes) -> ET.Element:
        SignedInfo = ET.SubElement(parent, "SignedInfo", {"xmlns": "http://www.w3.org/2000/09/xmldsig#"})
        ET.SubElement(
            SignedInfo,
    ...
    def AcquireLicenseMessage(
        ...
        Signature = ET.SubElement(Challenge, "Signature", {"xmlns": "http://www.w3.org/2000/09/xmldsig#"})
        ...
        signed_info_xml = ET.tostring(SignedInfo, encoding="utf-8", short_empty_elements=False)

        SignatureValue = ET.SubElement(Signature, "SignatureValue")
        SignatureValue.text = base64.b64encode(Crypto.ecc256_sign(signing_key, signed_info_xml)).decode()
