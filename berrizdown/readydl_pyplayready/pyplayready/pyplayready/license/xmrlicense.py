...
class _XMRLicenseStructs:
    ...
    ECCKeyObject = Struct("curve_type" / Int16ub, "key_length" / Int16ub, "key" / Bytes(this.key_length))
    ...
    PolicyMetadataObject = Struct("metadata_type" / Bytes(16), "policy_data" / Bytes(this._.length - 24))
    ...
    AuxiliaryKeysObject = Struct("count" / Int16ub, "auxiliary_keys" / Array(this.count, AuxiliaryKey))
...
class XMRLicense(_XMRLicenseStructs):
    ...
    @classmethod
    def loads(cls, data: str | bytes) -> XMRLicense:
