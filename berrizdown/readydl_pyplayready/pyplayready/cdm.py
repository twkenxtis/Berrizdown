...
class Cdm:
    ...
    def __init__(
        ...
        encryption_key: ECCKey | None,
        signing_key: ECCKey | None,
    ...
    def _get_key_data(self, session: Session) -> bytes:
        return self.__crypto.ecc256_encrypt(public_key=self._wmrm_key, plaintext=session.xml_key.get_point())
    ...
    def _get_cipher_data(self, session: Session) -> bytes:
        ...
        body = xmltodict.unparse(
            {
                "Data": {
                    "CertificateChains": {"CertificateChain": b64_chain},
                    "Features": {
                        "Feature": {"@Name": "AESCBC", "#text": '""'},
                        "REE": {"AESCBCS": None},
                    },
                }
            },
        ...
        cipher = AES.new(key=session.xml_key.aes_key, mode=AES.MODE_CBC, iv=session.xml_key.aes_iv)
                        ...
                        "challenge": {
                            "Challenge": {
                                ...
                                "Signature": {
                                    ...
                                    "KeyInfo": {
                                        "@xmlns": "http://www.w3.org/2000/09/xmldsig#",
                                        "KeyValue": {"ECCKeyValue": {"PublicKey": public_signing_key}},
                                    },
                                },
                            }
                        },
    ...
    def _build_digest_content(
        ...
        return {
            "LA": {
                ...
                "CLIENTINFO": {"CLIENTVERSION": self.client_version},
                "LicenseNonce": nonce,
                ...
                "EncryptedData": {
                    ...
                    "KeyInfo": {
                        ...
                        "EncryptedKey": {
                            ...
                            "CipherData": {"CipherValue": wmrm_cipher},
                        },
                    },
                    "CipherData": {"CipherValue": cert_cipher},
                },
            }
        }
